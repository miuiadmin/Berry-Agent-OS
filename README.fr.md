...
**28** modules (tous implémentés) · **27** crochets de cycle de vie · **28** types d'événements durables · **15** pièces officielles (14 Ring 2 + l'application par défaut berrycode, chacune déchargeable) · **2 700+** tests · **0** télémétrie.
