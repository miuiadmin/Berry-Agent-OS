...
**28** modules (tous implémentés) · **27** crochets de cycle de vie · **27** types d'événements durables · **15** pièces officielles (14 Ring 2 + l'application par défaut berrycode, chacune déchargeable) · **2 700+** tests · **0** télémétrie.
...
Nécessite Node.js ≥ 24. Trois façons d'installer (guide complet dans [docs/使用指南](docs/使用指南.md) §1) :
