...
const en: Record<string, string> = {
  ...
  "missions.subtitle": "Multi-agent collaborative task management",
  "missions.count": "{count} missions",
  "missions.noActive": "No active missions",
  "missions.noTasksYet": "No tasks yet",
  "missions.selectToView": "Select a mission to view details",
  "missions.failedToLoad": "Failed to load mission details",
  "missions.noSquad": "No Squad Structure",
  "missions.noSquadDesc": "This mission uses flat task coordination without squad organization.",
  "missions.recentSignals": "Recent Signals",
  "missions.goalLabel": "Goal: ",
  "missions.leaderLabel": "Leader: ",
  "missions.dependsLabel": "depends: ",
  "missions.progressLabel": "{done}/{total} tasks",
