...
import { SCHEDULER_MIGRATION, SCHEDULER_V9_MIGRATION } from './schema.js';

/** 件自带迁移链（v7 jobs 表 + v9 三列——组合根机械聚合的标准名） */
export const migrations: MigrationSpec[] = [SCHEDULER_MIGRATION, SCHEDULER_V9_MIGRATION];

export { SCHEDULER_MIGRATION, SCHEDULER_V9_MIGRATION } from './schema.js';
...
export { createSchedulerApp } from './app.js';
export type { SchedulerAppDeps } from './app.js';
