/**
 * L1 persist — 原子写公共件（插件契约篇 §1.5.1(b)，2026-08-23 M2 /reload 纵切兑现）。
 *
 * 纪律：**禁止插件逐个复刻 writeAtomic**（dsh-chat-import 裸 node:fs 复刻原子写反例）
 * ——需要原子写的面（宿主 overlay 写回、Ring 2/3 插件落盘）一律用本件。
 *
