 ...
 *
 * provider 应用的正路（四包移植挖矿实证：三家 provider 类应用全在自拼传输层
 * 绕过宿主）：pi-ai 的 provider 工厂族经虚拟面背书导出——应用用**宿主同版本**
 ...
 *   收窄守卫——应用 registerProvider 路径的两件套；
 ...
 *   可达——应用应优先走 createProvider 全链而非裸拿 api 流；确需扩展时按需
