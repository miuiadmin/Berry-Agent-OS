...
**28** modules (all implemented) · **27** lifecycle hooks · **27** durable event types · **15** official bundle pieces (14 Ring 2 + default berrycode app, each unloadable) · **2,700+** tests · **0** telemetry.
