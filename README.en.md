...
**28** modules (all implemented) · **27** lifecycle hooks · **28** durable event types · **15** official bundle pieces (14 Ring 2 + default berrycode app, each unloadable) · **2,700+** tests · **0** telemetry.
...
Requires Node.js ≥ 24. Three ways to install (full guide in [docs/使用指南](docs/使用指南.md) §1):
