...
> ⚠️ **2026-07-22：18.0 重置起草中**（2026-08-22 目录重组）。`设计文档/` 分四类：`01-规范/`（已拍板决策）、`02-计划/`（实施路线）、`03-参考/`（外部对标分析）、`废弃/`（v2 / 17.0 / berryagentOS 过程稿归档，逐篇摘要见 `废弃/README.md`）。当前主线 = [`设计文档/02-计划/18.0-重置路线图.md`](../设计文档/02-计划/18.0-重置路线图.md)。
