...
**当前架构标准：[15.0](./设计文档/21-架构升级-15.0.md)** — Brain 中心化治理（权限三级审批 / BrainEscalation / Auditor 后置审计 / brain.command 指挥通道）+ 存储层加固（FTS5 双索引 / 写竞争 jitter / redact 关卡 / WAL checkpoint / 声明式 schema 演进）。
